...
| `scheme=’muscl’`       |`Character LEN=20`| Name of the desired Godunov integrator. The hydro solver accepts only ’muscl’ (MUSCL-HANCOCK scheme), the option ’pldme’ (Collela's PLMDE scheme) has been removed in 2025. The MHD solver accepts ’muscl’ or ’induction’. |
