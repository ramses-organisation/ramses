...
!================================================================
!================================================================
SUBROUTINE quick_sort_int_two_val(list, order1, order2, n)
  ...
  INTEGER :: n
  integer, DIMENSION (1:n), INTENT(INOUT)  :: list
  INTEGER, DIMENSION (1:n), INTENT(INOUT)  :: order1,order2
    ...
    ELSE
       ...
       DO
          ...
          IF (i < j) THEN
             ! Swap two out-of-order elements
             temp = list(i); list(i) = list(j); list(j) = temp
             temp = order1(i); order1(i) = order1(j); order1(j) = temp
             temp = order2(i); order2(i) = order2(j); order2(j) = temp
          ELSE IF (i == j) THEN
             i = i + 1
             EXIT
          ELSE
...
END SUBROUTINE quick_sort_int_two_val
!================================================================
!================================================================
!================================================================
!================================================================
subroutine sort_zeros(list, order1, order2, n, z)
    implicit none
    integer, dimension(1:n) :: list, order1, order2
    integer :: n,z
    ! This routine searches for the zeros in list and put them
    ! at the beginning of the array
    ! n is the size of list and z will be the number of zeros found
    integer :: nz,tmp
    ...
    do
        ...
        if(nz>z) exit
         ...
         list(z) = list(nz); list(nz) = 0
         tmp = order1(nz); order1(nz) = order1(z); order1(z) = tmp
         tmp = order2(nz); order2(nz) = order2(z); order2(z) = tmp

    end do


end subroutine sort_zeros