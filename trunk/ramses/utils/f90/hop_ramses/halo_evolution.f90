program halo_evolution
  ...
  integer,dimension(:),allocatable::group_id,n_group,group_id_2,group_id_3,ind_new_3,list,group_id_4,npart_halo
  ...
  integer,dimension(:),allocatable::id,id_new,id_new_2,ind_new_2
