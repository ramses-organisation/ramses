  ...
  do igrid=1,ncache,nvector
     ...
     do ind=1,twotondim
        ...
        do i=1,nnew
           ...
           msink_new(index_sink)=min((d-d_thres)*vol_loc,msink_max)
...
subroutine compute_accretion_rate(ilevel)
  ...
  if(myid==1.and.ilevel==levelmin.and.nsink>0.and.mod(nstep_coarse,ncontrol)==0)then
     do i=1,nsink
        xmsink(i)=msink(i)
     end do
     call quick_sort(xmsink(1),idsink_sort(1),nsink)
     ...
     write(*,*)'========================================================================================================================================='
     write(*,*)'Id     Mass(Msol)              x              y              z             vx             vy             vz      new_born'
     write(*,*)'========================================================================================================================================='
     do i=nsink,1,-1
        isink=idsink_sort(i)
        write(*,'(I6,7(1X,1PE14.7),X,X,X,X,X,I1)')idsink(isink),msink(isink)*scale_m/2d33,xsink(isink,1:ndim),vsink(isink,1:ndim),new_born_all(isink)
     end do
     write(*,*)'========================================================================================================================================='
  endif
