...
! compute gradient
  ...
  if (disp_length > dx_loc)then
     write(*,*)'displacement to true maximum is too big and therefore shortened to dx.'
     displacement(1)=displacement(1)/disp_length*dx_loc
     displacement(2)=displacement(2)/disp_length*dx_loc
     displacement(3)=displacement(3)/disp_length*dx_loc
  end if
