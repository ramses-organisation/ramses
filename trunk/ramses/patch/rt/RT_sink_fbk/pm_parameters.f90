module pm_parameters
  ...
  real(dp)::T2_max=1.d10                      ! Maximum allowed temperature of the AGN blast; in K
  real(dp)::T2_AGN=1.d12                     ! AGN blast temperature; in K

  real(dp)::v_max=5.d4                       ! Maximum allowed velocity of the AGN blast; in km/s; default=0.42c
  !real(dp)::v_max=1.26e5                     ! Maximum allowed velocity of the AGN blast; in km/s; default=0.42c
  ...
  logical::quench_AGN=.false.                ! Switch for enabling quenching of AGN seeds
