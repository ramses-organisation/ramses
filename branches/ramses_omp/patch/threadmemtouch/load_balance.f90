     ...
     do ilevel=1,nlevelmax
        do ibound=1,nboundary+ncpu
           ...
           if(ncache>0)then
              igrid=istart
              do i=1,ncache
                 buf_dp2d(ngrid2+i,idim)=xg(igrid,idim)
                 igrid=next(igrid)
              end do
              ngrid2=ngrid2+ncache
           end if
     ...
     do ilevel=1,nlevelmax
        do ibound=1,nboundary+ncpu
           ...
           if(ncache>0)then
              igrid=istart
              do i=1,ncache
                 buf_int2d(ngrid2+i,ind)=cpu_map(iskip2+igrid)
                 igrid=next(igrid)
              end do
              ngrid2=ngrid2+ncache
           end if
     ...
     do ilevel=1,nlevelmax
        do ibound=1,nboundary+ncpu
           ...
           if(ncache>0)then
              igrid=istart
              do i=1,ncache
                 buf_int2d(ngrid2+i,ind)=flag2(iskip2+igrid)
                 igrid=next(igrid)
              end do
              ngrid2=ngrid2+ncache
           end if
     ...
     do ilevel=1,nlevelmax
        do ibound=1,nboundary+ncpu
           ...
           if(ncache>0)then
              igrid=istart
              do i=1,ncache
                 buf_dp3d(ngrid2+i,ind,ivar)=uold(iskip2+igrid,ivar)
                 igrid=next(igrid)
              end do
              ngrid2=ngrid2+ncache
           end if
        ...
        do ilevel=1,nlevelmax
           do ibound=1,nboundary+ncpu
              ...
              if(ncache>0)then
                 igrid=istart
                 do i=1,ncache
                    buf_dp3d(ngrid2+i,ind,idim)=f(iskip2+igrid,idim)
                    igrid=next(igrid)
                 end do
                 ngrid2=ngrid2+ncache
              end if
     ...
     do ilevel=1,nlevelmax
        do ibound=1,nboundary+ncpu
           ...
           if(ncache>0)then
              igrid=istart
              do i=1,ncache
                 buf_int2d(ngrid2+i,ind)=rho(iskip2+igrid)
                 igrid=next(igrid)
              end do
              ngrid2=ngrid2+ncache
           end if
     ...
     do ilevel=1,nlevelmax
        do ibound=1,nboundary+ncpu
           ...
           if(ncache>0)then
              igrid=istart
              do i=1,ncache
                 buf_int2d(ngrid2+i,ind)=phi(iskip2+igrid)
                 igrid=next(igrid)
              end do
              ngrid2=ngrid2+ncache
           end if
        ...
        do ilevel=1,nlevelmax
           do ibound=1,nboundary+ncpu
              ...
              if(ncache>0)then
                 igrid=istart
                 do i=1,ncache
                    buf_int2d(ngrid2+i,ind)=rho_top(iskip2+igrid)
                    igrid=next(igrid)
                 end do
                 ngrid2=ngrid2+ncache
              end if
