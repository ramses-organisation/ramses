...
!$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(i,ngrid,igrid,ind_grid,ind,ind_cell,iskip,nleaf,ind_leaf,uu,ivar,gg,idim,dt_lev) REDUCTION(+: mass_loc, ekin_loc, eint_loc) REDUCTION (min:dt_loc)
