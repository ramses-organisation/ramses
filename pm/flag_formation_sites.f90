...
subroutine flag_formation_sites
  ...
  do j=npeaks,1,-1
     ...
     if (smbh)then
        ...
        ! Peak density has to be larger than 3x star formation thresold (see Wu,Cen and Teyssier 25/26 rules of seeding)
        ok=ok.and.max_dens(jj)>3.0d0*n_star/scale_nH
