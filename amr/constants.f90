module constants
...
#else ! take the ramses-ism values for getting automatic tests cases passed
  ...
  real(dp),parameter ::mH           = 1.6600000d-24 ! H atom mass [g] = amu, i.e. atomic mass unit; NIST
  real(dp),parameter:: a_r=7.56591469318689378e-015_dp
#endif
