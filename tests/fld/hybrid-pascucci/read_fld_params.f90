subroutine read_fld_params(namelist_unit,nml_ok)
   ...
   namelist/radiation_params/grey_rad_transfer,dtdiff_params,dt_control &
        ...
        & ,numin,numax,Tr_floor,robin,opacity_type,rad_trans_model,min_optical_depth,rt_feedback,Tray_min &
        ...
        & ,sinks_opt_thin, fit_semenov,stellar_photon,Tstar,rstar,test,rho_disk0,Rin,isoscat
