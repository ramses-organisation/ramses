...
fig.savefig('sfonly.pdf',bbox_inches='tight')
fig.savefig('sfonly.png') # => produces a sharper figure on mac
...
visu_ramses.check_solution(to_check, 'sfonly',tolerance=tolerance)#,overwrite=True)
