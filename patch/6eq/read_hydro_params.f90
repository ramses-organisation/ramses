subroutine read_hydro_params(nml_ok)
  ...
  namelist/boundary_params/nboundary,bound_type &
       ...
       & ,p1_bound,p2_bound,p3_bound,p4_bound &
       & ,no_inflow
...
104 if(nboundary>MAXBOUND)then
  ...
  if(nboundary>0)then
    ...
    do idim=1,ndim
       do i=1,nboundary
          boundary_var(i,2*nmat+idim)    = dtot(i)*q(i,idim)
