...
!!!$omp parallel do private(nbatch,i,ind_f,ind_average,iskip_f_mg,iskip_f_amr,ind_father,ind_c,igrid_c_mg,igrid_c_amr,icell_f_mg,icell_c_mg,icell_c_amr,cpu_c_amr,coeff)
!TC test fail
