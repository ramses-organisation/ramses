...
-------------
     ...
     flags.
     for a purely esthetical image, use --no-lables --tex flags.
...
-------------
     ...
     -pdf                    save image as a pdf file instead of a png file.
...
#==============================================================
def _draw_straight_lines(x_values, ax, colorlist, strategy):
#==============================================================
    """
    strategy:   for what to adapt plot for
    """
...
#=======================================================
    ...
    # draw the tree
    _draw_straight_lines(x_values, ax, params.colorlist, strategy)
