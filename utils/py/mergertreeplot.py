...
#                               script will first make a new directory "tex/"
#                               and save a tex file in there, which will then be
#                               compiled to produce a pdf in the current working
#                               directory. 
#                               If you only want the tex file without 
#                               compilation, use -T or --tex instead.
#                               The command for compilation is
#                                 $ pdflatex -synctex=1 -interaction=nonstopmode
#                               If you prefer to use another one, you can change
#                               the command string used in the _save_fig() 
#                               function.
#                               stdout of pdflatex will be written to /dev/null.
#                               WARNING:    Needs the matplotlib2tikz library
...
#======================
    ...
    #========================
        ...
        print "last directory:", self.lastdir
        if self.start > 0:
...
#====================================================================
    ...
    if params.start > 0:
        ...
        outputnr = yaxis_int[params.start-1:].tolist() + [yaxis_int[-1]-1]
    else:
