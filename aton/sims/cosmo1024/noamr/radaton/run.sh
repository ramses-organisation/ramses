...
#MSUB -n 128                  # Reservation de 4 processus au total
#MSUB -N 64                  # Les processus sont répartis sur 2 noeuds
...
mpirun $BRIDGE_MSUB_PWD/ramses3d $BRIDGE_MSUB_PWD/rad.nml > log_$DATE.log
